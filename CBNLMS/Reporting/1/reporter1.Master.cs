...
namespace CBNLMS.Reporting._1
{
    public partial class reporter1 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Reporter_1"] == null || Session["Email"] == null)
            {
            ...
            {
                {
                    ...
                    welcomename = Session["Reporter_1"].ToString();
