<%@ Page Title="" Language="C#" MasterPageFile="~/Reporting/2/Reporter2.Master" AutoEventWireup="true" CodeBehind="customerlist.aspx.cs" Inherits="CBNLMS.Reporting._2.customerlist" %>
                                                                        ...
                                                                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_OnItemCommand">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:LinkButton ID="linkbutton" class="btn btn-primary" dripicons-user-id="Linkbutton2" CommandName="Details" CommandArgument='<%# Bind("BVN") %>' runat="server" Text="PROFILE" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
                                                                        ...
                                                                        <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_OnItemCommand">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:LinkButton ID="linkbutton1" class="btn btn-primary" dripicons-user-id="Linkbutton2" CommandName="Details" CommandArgument='<%# Bind("tin_no") %>' runat="server" Text="PROFILE" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
                                                                        ...
                                                                        <asp:Repeater ID="Repeater3" runat="server" OnItemCommand="Repeater3_OnItemCommand">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:LinkButton ID="linkbutton1" class="btn btn-primary" dripicons-user-id="Linkbutton2" CommandName="Details" CommandArgument='<%# Bind("phone") %>' runat="server" Text="PROFILE" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
                                                                        ...
                                                                        <asp:Repeater ID="Repeater4" runat="server" OnItemCommand="Repeater4_OnItemCommand">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:LinkButton ID="linkbutton1" class="btn btn-primary" dripicons-user-id="Linkbutton2" CommandName="Details" CommandArgument='<%# Bind("state_name") %>' runat="server" Text="PROFILE" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
