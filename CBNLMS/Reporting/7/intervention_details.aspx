<%@ Page Title="" Language="C#" MasterPageFile="~/Reporting/7/Reporter7.Master" AutoEventWireup="true" CodeBehind="intervention_details.aspx.cs" Inherits="CBNLMS.Reporting._7.intervention_details" %>
  ...
  document.getElementById("yearnow").innerHTML = n;
    ...
    function drawRegionsMap() {
      ...
      if (selection.length > 0) {
          ...
          var urlnow = currentUrl + '/Reporting/7/reportdetails?state=' + data.getValue(selection[0].row, 0);
