...
{
    public partial class Approval_report : System.Web.UI.Page
    {
        ...
        {
            if (Session["ApproveReport"] == null)
            {
                Response.Redirect("~/Reporting/7/approve_loan.aspx");
            }
            else
            {

            }
            loanid = Session["ApproveReport"].ToString();
