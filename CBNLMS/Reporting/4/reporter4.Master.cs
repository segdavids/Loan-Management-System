...
namespace CBNLMS.Reporting._4
{
    public partial class reporter4 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Reporter_4"] == null || Session["Email"] == null)
            {
            ...
            {
                {
                    ...
                    welcomename = Session["Reporter_4"].ToString();
