...
namespace CBNLMS.Reporting._6
{
    public partial class reporter6 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Reporter_6"] == null || Session["Email"] == null)
            {
            ...
            {
                {
                    ...
                    welcomename = Session["Reporter_6"].ToString();
