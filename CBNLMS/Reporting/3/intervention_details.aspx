<%@ Page Title="" Language="C#" MasterPageFile="~/Reporting/3/reporter3.Master" AutoEventWireup="true" CodeBehind="intervention_details.aspx.cs" Inherits="CBNLMS.Reporting._3.intervention_details" %>
...
function yearnowget() {
  ...
  document.getElementById("yearnow").innerHTML = n;
    ...
    function drawRegionsMap() {
        ...
        $.ajax({
            type: "POST",
            url: "intervention_details.aspx/GetMapData",
            data: '{}',
      ...
      if (selection.length > 0) {
          ...
          var urlnow = currentUrl + '/Reporting/3/reportdetails?state=' + data.getValue(selection[0].row, 0);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        vAxis: {
           ...
           $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetSector",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
     ...
     <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
       function drawChart() {
          ...
          slices: {  4: {offset: 0.2},
            ...
            $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetPieZone",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
      ...
      function drawChart() {
          ...
          pieSliceText: 'label',
           ...
           $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetPieDatagender",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
  ...
  $.ajax({
            type: "POST",
            url: "intervention_details.aspx/GetMap2Data",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
 ...
 $.ajax({
            type: "POST",
            url: "intervention_details.aspx/disvsout",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
   ...
   legend: {textStyle: {color: '#b1b1b1'}},
        ...
        $.ajax({
            type: "POST",
            url: "intervention_details.aspx/GetChartData",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
  ...
  easing: 'in',
           ...
           $.ajax({
            type: "POST",
            url: "intervention_details.aspx/getmodel",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
  ...
  easing: 'in',
           ...
           $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetPieData",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
      ...
      colors: ['green','red'],
        ...
        easing: 'out'
          ...
          vAxis: {minValue: 0,  title: 'Amount DIsbursed(Mi)',
            ...
            $.ajax({
                type: "POST",
                url: "intervention_details.aspx/Getqdate",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
 ...
 $.ajax({
            type: "POST",
            url: "intervention_details.aspx/disvsrecovery",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
    ...
    <script type="text/javascript">
      ...
      <script type="text/javascript">
        ...
        vAxis: {
            ...
            $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetBarData",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
...
colors: ['red','green'],
        ...
        vAxis: {
            ...
            $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetBarData2",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
     ...
     <script type="text/javascript">
      ...
      backgroundColor: 'transparent'
        ...
        easing: 'out'
           ...
           $.ajax({
            type: "POST",
            url: "intervention_details.aspx/Getcollection",
            data: '{}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
               success: function (r) {
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
          ...
          pieSliceText: 'label',
           ...
           $.ajax({
                type: "POST",
                url: "intervention_details.aspx/GetPieloanstat",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Intervention Report - <span id="interventionname" runat="server"> </span> </h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Default.aspx"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Reports</li>
								<li class="breadcrumb-item active" aria-current="page">Intervention</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<section class="content">
            <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label text-right" style="color: white">Select a Report to View</label>
                    <div class="col-sm-3">
                        ...
                        <asp:DropDownList ID="DropDownList9" runat="server" class="select2 form-control mb-3 custom-select" AutoPostBack="True" OnSelectedIndexChanged="DropDownList9_SelectedIndexChanged">
                            ...
                            <asp:ListItem>Data Tables</asp:ListItem>
            ...
            <div class="row" id="analytics" runat="server">
            ...
            <div class="row" id="datatables" runat="server">
