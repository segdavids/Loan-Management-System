<%@ Page Title="" Language="C#" MasterPageFile="~/Management/management.Master" AutoEventWireup="true" CodeBehind="viewschedule.aspx.cs" Inherits="CBNLMS.Management.viewschedule" %>
		...
		<section class="content">
             <div class="row">
				...
				<ul class="nav nav-tabs">
				  <li><a href="#perint" class="active" data-toggle="tab"><b>Amortization Schedule</b></a></li>
				  <li><a href="#usertimeline" class="" data-toggle="tab"><b>Obligor Profile</b></a></li>
                    ...
                    <div class=" tab-pane" id="usertimeline">
                     ...
                     <div class="box box-default">
                         <div class="box-header with-border">
                             <h4 class="box-title"><b>Obligor Information</b></h4>
                         </div>
                         <!-- /.box-header -->
                         <div class="box-body">
                             <div class="box-body">
                                            ...
                                            <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                                <div class="met-profile-main">
                                                    ...
                                                    <div class="met-profile_user-detail">
                                                        <h5 class="met-user-name" id="obligname" runat="server"><%#Eval("organization_name")%></h5>                                                        
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <h4 class="mt-0 header-title">All Customer Loans  </h4 ><h4 ></h4>
