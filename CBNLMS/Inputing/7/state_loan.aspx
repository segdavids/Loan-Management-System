<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/7/inputer7.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="state_loan.aspx.cs" Inherits="CBNLMS.Inputing._7.state_loan" %>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Amount Disbursed</label>
                                                    <input type="text" class="number form-control" required runat="server" step="0.01" id="Number11" placeholder="Amount Disbursed" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                        </div>
                                        <!--end col-->
