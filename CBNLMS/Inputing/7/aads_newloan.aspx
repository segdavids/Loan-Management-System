<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/7/inputer7.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="aads_newloan.aspx.cs" Inherits="CBNLMS.Inputing._7.aads_newloan" %>
                                            ...
                                            <div class="form-group ">
                                               <label>Intervention</label>
                                                <asp:DropDownList ID="DropDownList6" runat="server" class="select2 form-control mb-3 custom-select">
                                                       <asp:ListItem>NBET-PAF</asp:ListItem>
                                                    <asp:ListItem>NEMSF</asp:ListItem>
                                                    <asp:ListItem>PAIF</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <!--end col-->
