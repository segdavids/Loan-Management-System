<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/7/inputer7.Master" AutoEventWireup="true" CodeBehind="analytics_intervention.aspx.aspx.cs" Inherits="CBNLMS.Inputing._7.analytics_all" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type='text/javascript'>
        ...
        function drawRegionsMap() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetMapData",
                data: '{}',
                ...
                success: function (r) {
                    ...
                    google.visualization.events.addListener(chart, 'select', function () {
                        ...
                        if (selection.length > 0) {
                            ...
                            var urlnow = currentUrl + '/Inputing/7/reportdetails?state=' + data.getValue(selection[0].row, 0);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetSector",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetPieZone",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetPieDatagender",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type='text/javascript'>
        ...
        function drawRegionsMap() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetMap2Data",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/disvsout",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetChartData",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/getmodel",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetPieData",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/Getqdate",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/disvsrecovery",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetBarData",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetBarData2",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/Getcollection",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "analytics_intervention.aspx/GetPieloanstat",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
