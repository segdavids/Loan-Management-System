...
namespace CBNLMS.Inputing._4
{
    public partial class i4 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Inputer_4"] == null || Session["Email"] == null)
            {
            ...
            {
                {
                    ...
                    welcomename = Session["Inputer_4"].ToString();
