<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/4/inputer4.Master" AutoEventWireup="true" CodeBehind="newloan.aspx.cs" Inherits="CBNLMS.Inputing._4.newloan" %>
                            ...
                            <div class="col-lg-12">
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label for="txtNameCard" class="col-lg-3 col-form-label">Customer TIN</label>
                                                <div class="col-sm-9">
