<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/4/inputer4.Master" AutoEventWireup="true" CodeBehind="aads_newloan.aspx.cs" Inherits="CBNLMS.Inputing._4.aads_newloan" %>
                          ...
                          <div class="p-15">
                                <div class="col-lg-12 col-12">
                                    <div class="box">
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <h4 class="box-title text-info"><i class="ti-user mr-15"></i>Individual | Loan - Information</h4>
                                            <hr class="my-15">
                                            <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group ">
                                               <label>Intervention</label>
                                                <asp:DropDownList ID="DropDownList6" runat="server" class="select2 form-control mb-3 custom-select">
                                                    <asp:ListItem>AGSMEEIS</asp:ListItem>
                                                        <asp:ListItem>CIFI</asp:ListItem>
                                                        <asp:ListItem>YEDP</asp:ListItem>
                                                        <asp:ListItem>TCF</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <!--end col-->
                           ...
                           <div class="p-15">
                                <div class="col-lg-12 col-12">
                                     <div class="box">
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <h4 class="box-title text-info"><i class="ti-user mr-15"></i>Corporate-Customer | Loan - Information</h4>
                                            <hr class="my-15">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
