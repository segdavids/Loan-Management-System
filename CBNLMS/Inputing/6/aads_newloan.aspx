<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/6/inputer6.Master" AutoEventWireup="true" CodeBehind="aads_newloan.aspx.cs" Inherits="CBNLMS.Inputing._6.aads_newloan" %>
                                            ...
                                            <div class="form-group ">
                                               <label>Intervention</label>
                                                <asp:DropDownList ID="DropDownList6" runat="server" class="select2 form-control mb-3 custom-select">
                                                 <asp:ListItem>MSMEDF</asp:ListItem>
                                                    <asp:ListItem>SANEF</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <!--end col-->
