<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/2/inputer2.Master" AutoEventWireup="true" CodeBehind="analytics_intervention.aspx.aspx.cs" Inherits="CBNLMS.Inputing._2.analytics_all" %>
                ...
                success: function (r) {
                    ...
                    google.visualization.events.addListener(chart, 'select', function () {
                        ...
                        if (selection.length > 0) {
                            ...
                            var urlnow = currentUrl + '/inputing/2/reportdetails?state=' + data.getValue(selection[0].row, 0);
