<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/3/inputer3.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="corporate_loan.aspx.cs" Inherits="CBNLMS.Inputing._3.corporate_loan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:ListItem>CACS</asp:ListItem>
                                                    ...
                                                    <asp:ListItem>RDF</asp:ListItem>                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
