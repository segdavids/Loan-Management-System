<%@ Page Title="" Language="C#" MasterPageFile="~/Inputing/3/inputer3.Master" AutoEventWireup="true" CodeBehind="analytics_intervention.aspx.aspx.cs" Inherits="CBNLMS.Inputing._3.analytics_all" %>
                ...
                success: function (r) {
                    ...
                    google.visualization.events.addListener(chart, 'select', function () {
                        ...
                        if (selection.length > 0) {
                            ...
                            var urlnow = currentUrl + '/Inputing/3/reportdetails?state=' + data.getValue(selection[0].row, 0);
