<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="aads_analytics.aspx.cs" Inherits="CBNLMS.aads_analytics" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['Feb',  174744650,      51327000,         46818000,             48197000,           89110000,      29740000],
          ['Mar',  24288400,      0,        253198000,             0,          0,      96893000],
          ['April',  24288400,      10169800,        4032000,             5930000,           15000000,      12640000],
          ['May',  15001150,      15848850,        1754300,             1087000,           215,      2990000],
          ['June',  250586065,      149678414,         253198000,             96893000,          335614902.5,      185197663.6]
        ]);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'AADS Disbursement by Zone',
          legend: 'none',
          pieSliceText: 'label',
          slices: {  4: {offset: 0.2},
                    0: {offset: 0.3},
    ...
    <script type='text/javascript'>
     ...
     google.charts.setOnLoadCallback(drawRegionsMap);
        ...
        var ab = 1105642595; var enug = 7312466504;
        ...
        var edo = 2712985257; var lago = 5585766856.49;
       ...
       var ab1 = 270; var enug1 = 187;
        var adm1 = 300; var gom1 = 505;
     ...
     google.charts.setOnLoadCallback(drawRegionsMap);
        ...
        var ab2 = 905642595; var enug2 = 712466504;
        var adm2 = 340481610; var gom2 = 0997214718;
        ...
        var baye2 = 1124415523.37; var katsi2 = 156213395;
        var crossriv2 = 453862293; var kebbi2 = 208918385;
        var del2 = 804853626; var kogi2 = 206381020;
     ...
     <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['2018', 2414212389.4770, 993958930.22],
          ['2019', 25986351734.69, 14893958930.12],
          ['2020', 16893958930.65, 1093958930.64]
        ]);
...
['WELLNESS & SPA',6620000],
['PRODUCTION OF BEAUTY PRODUCTS',5000000],
['PRODUCTION PALM OIL',1460000],
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Prime',      64200000000],
          ['Private',  56320000000],
          ['Association', 129250000000],
          ['Individual',    3900000000]
        ]);
     ...
     <script type="text/javascript">
      ...
      function drawVisualization() {
       ...
       var data = google.visualization.arrayToDataTable([
        ['Year', 'Wet',  'Dry'],
        ['2018', 3410554333, 610923422.55],
        ['2019', 5020344971.33, 2710453290.4],
        ['2020', 6692503000, 3989395893.64]
      ]);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['2019', 12986351734.69, 4893958930.12],
          ['2020', 44893958930.65, 9893958930.64]
        ]);
                        ...
                        <div class="col-lg-4">                                                        
                            ...
                            <div class="card">
                                <div class="card-body">                                    
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <h4 class="header-title mt-0 mb-3">AADS Disbursement by Zone</h4> 
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-3">
                                    ...
                                    <div class="row">                                            
                                        <div class="col-8 align-self-center">
                                            <div class="impressions-data">
                                                <h4 class="mt-0 header-title">Total Loan Disbursed - AADS</h4>
                             ...
                             <div class="card">
                                <div class="card-body mb-0">
                                    <div class="row">                                            
                                        <div class="col-8 align-self-center">
                                            <div class="impressions-data">
                                                <h4 class="mt-0 header-title">Total Outstanding - AADS</h4>
                                                <h4 class="mt-0"><span id="Span1" runat="server">₦31,985,233,412.21</span> </h4> 
                                            </div>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </div><!--end card-body-->
                         ...
                         <div class="col-lg-3">                                                        
                            <div class="card">
                                <div class="card-body">  
                                    <h4 class="header-title mt-0">Disbursement Timeline - AADS</h4>                                 
                                    <div class="">
                      ...
                      <div class="col-lg-3">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h4 class="header-title mt-0">AADS Disbursement by Model</h4>
                                  <div class="">
    ...
    <div id="piechart_3d" style="height: 300px;"></div>
            ...
            <div class="row">
             ...
             <div class="card" >
                                <div class="card-body ">
                                    <a href="#" class="float-right text-info">Inception - August 7, 2020</a>
                                    <h4 class="header-title mt-0 mb-3">AADS Amount disbursed per Bank </h4>
                ...
                <div class="col-md-6">
                      <div class="card" >
                                <div class="card-body ">
                                    <a href="#" class="float-right text-info">Inception - August 7, 2020</a>
                                    <h4 class="header-title mt-0 mb-3">AADS Disbursement By Business Sector - Geo Zones </h4>
