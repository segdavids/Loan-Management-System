<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="picture_upload.aspx.cs" Inherits="CBNLMS.Admin.picture_upload" %>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title"><span id="test" runat="server"></span>Upload Pictures per Season</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Default.aspx"><i class="mdi mdi-home-outline"></i>Home</a></li>
								<li class="breadcrumb-item" aria-current="page">Forms</li>
								<li class="breadcrumb-item" aria-current="page">Picture</li>
								<li class="breadcrumb-item active" aria-current="page">Seasonal Picture Upload</li>
							</ol>
						</nav>
					</div>
				</div>
