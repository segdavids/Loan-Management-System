<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="corporate_loan.aspx.cs" Inherits="CBNLMS.Admin.corporate_loan" %>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label>Facility Type</label>
                                                    <asp:DropDownList ID="DropDownList5" runat="server" class="select2 form-control mb-3 custom-select" AutoPostBack="True" OnSelectedIndexChanged="facilitytypechanged">
                                                    </asp:DropDownList>
                                            </div>
                                              ...
                                              <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label id="wcortlamount" runat="server">Amount Disbursed</label>
                                                         <input required class="number form-control" type="text" runat="server" step="0.01" id="Number6" onfocus="javascript:removeSeparator();" onblur="javascript:showSeparator();" placeholder="Amount Disbursed" aria-describedby="inputGroupPrepend">
                                                        </div>
