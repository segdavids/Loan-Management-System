<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="manage_office.aspx.cs" Inherits="CBNLMS.manageoffice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>DFD LMS | Manage Office</title>
</asp:Content>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Manage Office Locations <i class="ti-location-pin"></i></h3>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Style="table-layout: fixed" class="table table-striped table-bordered dt-responsive nowrap" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound" DataKeyNames="sn" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit" AllowPaging="True" OnPageIndexChanging="OnPaging" OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" EmptyDataText="No records has been added.">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DFO">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldfo" runat="server" Text='<%# Eval("dfo") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtdfo" runat="server" Text='<%# Eval("dfo") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="GEO-POLITICAL ZONE">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgeozone" runat="server" Text='<%# Eval("geo_zone") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtgeozone" runat="server" Text='<%# Eval("geo_zone") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="example-text-input">DFO</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="DropDownList1" runat="server" class="select2 form-control mb-3 custom-select" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                </div>
                                            </div>
                                            </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="example-text-input"">Geo_Zone</label>
                                                     <asp:TextBox ID="TextBox1" Readonly="true" class="form-control" runat="server" />
