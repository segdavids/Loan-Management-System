<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="abp_state_loan.aspx.cs" Inherits="CBNLMS.Admin.abp_state_loan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>DPF LMS | ABP State Loan</title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">ABP - New State Government Loan</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Default.aspx"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Forms</li>
								<li class="breadcrumb-item active" aria-current="page">ABP - New Loan - State Government</li>
							</ol>
						</nav>
					</div>
				</div>
			  ...
			  <div class="box box-default">
				...
				<div class="box-body">
					...
					<ul class="nav nav-tabs nav-fill" role="tablist">
						...
						<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#messages11" role="tab"><span></span> <span class="hidden-xs-down ml-15">STATE GOVERNMENT</span></a> </li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content tabcontent-border">
                              
						<div class="tab-pane active" id="messages11" role="tabpanel">
                            <div class="p-15">
                                <div class="col-lg-12 col-12">
                                  <div class="box">
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <h4 class="box-title text-primary"><i class="ti-info mr-15"></i>STATE GOVERNMENT | LOAN INFORMATION</h4>
                                            <hr class="my-15">
                                            <div class="row">
                                                <div class="col-md-6">
