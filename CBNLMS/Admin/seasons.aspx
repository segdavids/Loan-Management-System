<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="seasons.aspx.cs" Inherits="CBNLMS.Admin.seasons" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>DFD LMS | Manage Seasons</title>
</asp:Content>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Manage Season <i class="wi wi-day-rain"></i></h3>
       ...
       <div class="row">      
              <div class="col-lg-12 col-12">
                                    <div class="box">
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <h4 class="box-title text-primary"><i class="wi wi-day-rain"></i> Manage | All Seasons</h4>
                                            <hr class="my-15">
...
<%#(GridView1.PageIndex * GridView1.PageSize) + (GridView1.Rows.Count + 1)%>
                ...
                <asp:TemplateField HeaderText="SEASON">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lbldfo" runat="server" Text='<%# Eval("farm_season") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtdfo" runat="server" Text='<%# Eval("farm_season") %>' ></asp:TextBox>
                    </EditItemTemplate> 
                             ...
                             <div class="modal-dialog modal-lg">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h5 class="modal-title mt-0" id="myLargeModalLabel">Add Season</h5>
                                     ...
                                     <div class="modal-body">
                                         <div class="row">
                                             <div class="col-lg-12">
                                                         ...
                                                         <h4 class="mt-0 header-title">Add Season - Form</h4>
