<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="cifi_analytics.aspx.cs" Inherits="CBNLMS.cifi_analytics" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['Feb',  174744650,      52327000,         46818000,             38197000,           29110000,      29740000],
          ['Mar',  1754300,      0,        0,             1754300,          0,      0],
          ['April',  24288400,      10169800,        4032000,             5930000,           15000000,      12640000],
          ['May',  115001150,      135848850,        12754300,             1087000,           215,      2990000],
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'CIFI Disbursement by Zone',
          legend: 'none',
          pieSliceText: 'label',
          slices: {  4: {offset: 0.2},
                    0: {offset: 0.3},
    ...
    <script type='text/javascript'>
     ...
     google.charts.setOnLoadCallback(drawRegionsMap);
        ...
        var ab = 1105642595; var enug = 712466504;
     ...
     <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Unspecified', 551012458, 393958930.66],
          ['2018', 11414212389.4770, 4893958930.22],
          ['2019', 35986351734.69, 29893958930.12],
          ['2020', 34893958930.65, 11893958930.64]
        ]);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Prime',      14200000000],
          ['Private',  56320000000],
          ['Association', 169250000000],
          ['Individual',    1900000000]
        ]);
                        ...
                        <div class="col-lg-4">                                                        
                            ...
                            <div class="card">
                                <div class="card-body">                                    
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <h4 class="header-title mt-0 mb-3">CIFI Disbursement by Zone</h4> 
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-3">
                                    ...
                                    <div class="row">                                            
                                        <div class="col-8 align-self-center">
                                            <div class="impressions-data">
                                                <h4 class="mt-0 header-title">Total Loan Disbursed - CIFI</h4>
                             ...
                             <div class="card">
                                <div class="card-body mb-0">
                                    <div class="row">                                            
                                        <div class="col-8 align-self-center">
                                            <div class="impressions-data">
                                                <h4 class="mt-0 header-title">Total Outstanding - CIFI</h4>
                         ...
                         <div class="col-lg-3">                                                        
                            <div class="card">
                                <div class="card-body">  
                                    <h4 class="header-title mt-0">Disbursement Timeline - CIFI</h4>                                 
                                    <div class="">
                      ...
                      <div class="col-lg-3">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h4 class="header-title mt-0">CIFI Disbursement by Model</h4>
                                  <div class="">
    ...
    <div id="piechart_3d" style="height: 300px;"></div>
            ...
            <div class="row">
             ...
             <div class="card" >
                                <div class="card-body ">
                                    <a href="#" class="float-right text-info">Inception - August 7, 2020</a>
                                    <h4 class="header-title mt-0 mb-3">CIFI Amount disbursed per Bank </h4>
                ...
                <div class="col-md-6">
                      <div class="card" >
                                <div class="card-body ">
                                    <a href="#" class="float-right text-info">Inception - August 7, 2020</a>
                                    <h4 class="header-title mt-0 mb-3">CIFI Disbursement By Business Sector - Geo Zones </h4>
