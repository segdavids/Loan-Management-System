...
namespace CBNLMS
{
    public partial class cacs_analytics : System.Web.UI.Page
    {
        ...
        public void getstuff()
        {
            ...
            while (reader.Read())
            {
                double amount = reader.GetDouble(0)-23000452114;
        ...
        public void getstuff1()
        {
            ...
            while (reader.Read())
            {
                int amount = reader.GetInt32(0)-4211;
        ...
        public void getbanks()
        {
            ...
            while (reader.Read())
            {
                int amount = reader.GetInt32(0)-5;
                string naira = String.Format("{0:#,##0}", amount);
        ...
        public void getbusact()
        {
            ...
            while (reader.Read())
            {
                int amount = reader.GetInt32(0)-1266;
                string naira = String.Format("{0:#,##0}", amount);
