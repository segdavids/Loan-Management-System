...
namespace CBNLMS.Test
{
    public partial class Twice : System.Web.UI.Page
    {
        ...
        {
            string query = "select distinct TOP 10 (CASE WHEN farming_season is null then 'Not Specified' else farming_season end) as seasons, count(*) as cct from abp_intervention group by  farming_season order by CASE WHEN farming_season is null then 'Not Specified' else farming_season end asc";
